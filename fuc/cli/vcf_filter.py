...
def create_parser(subparsers):
    ...
    parser.add_argument(
        '--samples',
        metavar='PATH',
        help='File of sample names to apply the marking (one \n'
             'sample per line).'
    )
    parser.add_argument(
        '--drop_duplicates',
        metavar='TEXT',
        nargs='*',
        help='Only consider certain columns for identifying \n'
             'duplicates, by default use all of the columns.'
    )
    parser.add_argument(
        '--greedy',
        action='store_true',
        help='Use this flag to mark even ambiguous genotypes \n'
             'as missing.'
    )
    parser.add_argument(
        '--opposite',
        action='store_true',
        help='Use this flag to mark all genotypes that do not \n'
    ...
    parser.add_argument(
        '--filter_empty',
        action='store_true',
        help='Use this flag to remove rows with no genotype \n'
             'calls at all.'
    )
