...
fig.suptitle('customized_oncoplot_2.py', fontsize=20)

# Create the TMB plot.
samples = af.sorted_samples(['FAB_classification', 'Overall_Survival_Status'], mf=mf, nonsyn=True)
...
mf.plot_waterfall(count=count, ax=ax3, linewidths=0.5, samples=samples)
ax3.set_xlabel('')
...
plt.savefig('customized_oncoplot_2.png')
